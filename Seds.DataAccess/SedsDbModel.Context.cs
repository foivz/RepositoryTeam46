...
namespace Seds.DataAccess
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual DbSet<Student_Studies> Student_Studies { get; set; }
        ...
        public virtual ObjectResult<spSearchStudents_Result> spSearchStudents(string phrase)
        {
            var phraseParameter = phrase != null ?
                new ObjectParameter("Phrase", phrase) :
                new ObjectParameter("Phrase", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spSearchStudents_Result>("spSearchStudents", phraseParameter);
        }
    }
}
