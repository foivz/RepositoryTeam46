...
{
    public partial class OrganizationalUnitsGrid : BaseGrid<OrganizationalUnit>
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                BindGrid(SortingExpression, SortingDirection);  // zbog ovog sortingexpression nije radilo jer u 
        ...
        protected override bool Delete(int id)
        {
            if (UserProfile != null)
            {
                if (id > 0)
                {
                    Repository.OrganizationalUnits.Delete(id);
